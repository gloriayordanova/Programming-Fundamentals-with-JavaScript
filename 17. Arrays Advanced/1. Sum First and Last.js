...
indexOf() - find index of value (and will give us the number of the Index like what index of the array it is e.g. 0,1,2,3 etc); if indexOf() doesn't find the search element of the array, it returns -1
...
Also, we have for example again let arr = [10, 20, 30, 40, 50]; and when we console.log(arr.slice(1)); it will print [20, 30, 40, 50] (so everything after index 1 will be printed); 
